...
# define YCSB types
YCSB_TYPES = ["u50r50", "u40r60", "u30r70", "u20r80", "u5r95"]#["u50r50", "u40r60", "u30r70", "u20r80", "u10r90"]
...
columns = ["128", "120", "112", "104", "96", "88", "80", "72", "64", "56", "48", "40", "32"]
...
def process_directory(directory):
    ...
    for filename in os.listdir(directory):
        if filename.startswith("latency_enable_zipfian_") and filename.endswith(".txt"):
