...
# config
THREAD_NUMS = [32, 30, 28, 26, 24, 22, 20, 18, 16, 14, 12, 10, 8]  # [32, 28, 24, 20, 16, 12, 8]
# temporary: 99999 means static, later extracted separately
THRESHOLDS = [0, 50000, 80000, 10000000]
STRIDES = [8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192]
DEPTHS = [2]
CLIENT_IPS = ["192.168.6.4", "192.168.6.3", "192.168.6.5", "192.168.6.6"]
YCSB_TYPES = ["update"]#["update", "u90r10", "u80r20", "u70r30", "u60r40", "u50r50", "u40r60", "u30r70", "u20r80", "u10r90"]#["u50r50", "u40r60", "u30r70", "u20r80", "u10r90"]  # ["update", "u90r10", "u80r20", "u70r30", "u60r40", "ycsb_a", "u40r60", "u30r70", "u20r80", "u10r90"]
exp_type = ["enable"]
