...
YCSB_TYPES = ["adaption"] #, "u70r30", "ycsb_a", "u30r70"] #["u90r10", "u80r20","u70r30", "u60r40", 
...
EXP_TYPES = ["enable"]
exp_prefix = "pcie_atomic/adaption"
DIST_TYPES = ["zipfian"]
config_name = "adaption_config.json"
pcie = "pcie_atomic"
core_num = 4
                    ...
                    for depth in DEPTHS:
                        for threshold in THRESHOLDS:
                            ...
                            while retry_count < max_retries:
                                ...
                                for i in range(len(CLIENT_IPS)):
                                    log_file = f"../exp_log/agent/{exp_prefix}/latency_{exp_type}_agent_client_{distribution_type}_{ycsb_type}_{CLIENT_IPS[i]}_{thread_num}_{depth}_{threshold}_{pcie}.log"
