...
YCSB_TYPES = ["u40r60"]#["ycsb_a", "u40r60", "u30r70", "u20r80", "u10r90"]#["update","u70r30", "ycsb_a", "u30r70"] #, "u70r30", "ycsb_a", "u30r70"] #["u90r10", "u80r20","u70r30", "u60r40", 
...
def start_client_rdma(thread_num, depth, stride_value, log_file, client_ip, client_port, client_user, client_pass, ssh_client_ref):
    ...
    if client_ip == "192.168.6.9":
        ...
        command = f'cd /home/dell/sqs/rdma-core && ./make.sh && cd /home/dell/sqs/rdma-core/providers/mlx5/fusioncas/build && make -j && LD_PRELOAD="./libmlx5.so ./libibverbs.so" ./test/{execute_file} client {thread_num} {depth}'
