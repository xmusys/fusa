...
ssh_clients = [] # SSH client
                            ...
                            for i in range(len(CLIENT_IPS)):
                                ...
                                client_user = CLIENT_USERS[i]
                                client_pass = CLIENT_PASSWORDS[i]
                                log_file = f"../data/{client_ip}/{exp_prefix}/latency_{exp_type}_{distribution_type}_{ycsb_type}_{client_ip}_{thread_num}_{depth}_{threshold}_client{i+1}.log"
