...
YCSB_TYPES = ["ycsb_a"]#, "u80r20","u70r30", "u60r40", "ycsb_a", "u40r60", "u30r70", "u20r80", "u10r90"] #, "u70r30", "ycsb_a", "u30r70"] #["u90r10", "u80r20","u70r30", "u60r40", 
...
exp_prefix = "mixed"
DIST_TYPES = ["zipfian"]
uniform_path = "/home/dell/sqs/ycsb_output/1-node/uniform/a/ycsb_a"
    ...
    try:
        ...
        for i in range(len(CLIENT_IPS)):
            with open(config_path, 'r+', encoding='utf-8') as f:
                ...
                # modify target field
                if(i == 2 or i == 3):
                    compute_node['ycsb_path'] = uniform_path
                else:
