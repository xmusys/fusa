...
THRESHOLDS = [0, 10000000]#] 15000, 20000, 25000, 30000, 35000, 40000, 45000, 50000]          # client threshold
...
YCSB_TYPES = ["update"]#["update0.3","update0.5", "update0.7", "update0.9","update1.11"]#, "update0.5"] #, "u70r30", "ycsb_a", "u30r70"] #["u90r10", "u80r20","u70r30", "u60r40", 
