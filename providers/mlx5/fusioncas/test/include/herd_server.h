...
#ifndef HERD_SERVER_CPP
#define HERD_SERVER_CPP
...
// herdserver does not use any fusioncas optimizations
class HerdServer {
    public:
	typedef struct {
		uint64_t thread_id;
	...
	// Constructor
	HerdServer(size_t tcp_port, uint64_t numa, size_t mem_pool_size,
